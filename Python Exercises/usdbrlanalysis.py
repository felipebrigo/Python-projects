...
df=web.DataReader('BRL=x', data_source='yahoo', start='2012-01-01', end='2020-10-01')
print(df)
...
#Create a new array containing the scaled values from index 1764 to 2220
test_data=scaled_data[training_data_len - 60:2280, :]
...
#How to predict a stock price in a specific date (01-10-2019)
#Get the quote
apple_quote=web.DataReader("BRL=x", data_source='yahoo', start='2012-01-01', end='2020-10-01')
